...
RSpec.describe ConfirmationText do
  ...
  # I can't get this test to work with this API
  # xit "sends a message" do
  #   customer = double :customer, name: "Sophie", mobile_number: "+447557942369"
  #   requester = double :requester
  #   text = ConfirmationText.new(customer)
  #   expect(text.message).to receive(:gets).with("https://api.twilio.com/2010-04-01/Accounts/ACee81d43509a2a51b841d04f24296df35/Messages.json")
